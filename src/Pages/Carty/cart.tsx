              ...
              <div className="cart-grid">
                    ...
                    <div key={item.id} className="cart-item">
                      <div className="cart-item-row">
                        ...
                        <div className="cart-qty-controls">
                          ...
                          {/* Remove Button */}
                          <button onClick={() => removeItem(item.id, item.name)} className="cart-remove-btn">
                            <FaTrash size={14} />
                          </button>
                        </div>
                      </div>
                      ...
                      <div className="cart-item-subtotal">
                        ...
                        <span className="cart-item-subtotal-value">₦{(item.price * item.quantity).toFixed(2)}</span>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div>
                  <div className="cart-summary">
                    ...
                    {subtotal < 25000 && (
                      <div className="cart-free-delivery">
                        <p className="cart-free-delivery-text">
                          Add ₦{(25000 - subtotal).toFixed(2)} more for free delivery!
                        </p>
                      </div>
                    )}
                    ...
                    {/* Continue Shopping */}
                    <button onClick={() => (window.location.href = "/menu")} className="cart-continue-btn">
                      Continue Shopping
                    </button>
                  </div>
                </div>
